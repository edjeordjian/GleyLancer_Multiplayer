...
Jefe1Vista::Jefe1Vista(int pos_x, int pos_y, CargadorTexturasEnemigos *cargador)
        : EnemigoVista(){

    this->texturas = cargador->getTexturas(TIPO_JEFE_1);
    ...
    initRect(&this->sprite_actual, 0, 0, ANCHO_JEFE_1, ALTO_JEFE_1);

    // Tamaño visualizado en pantalla
    initRect(&this->posicion, pos_x, pos_y, ANCHO_JEFE_1, ALTO_JEFE_1);
...
void Jefe1Vista::actualizar(int pos_x, int pos_y, int direccion, bool herido){
